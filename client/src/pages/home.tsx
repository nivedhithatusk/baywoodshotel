  ...
  return (
    <Layout>
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto space-y-6">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-light text-white/80 mb-2">
              {HOTEL_INFO.type}
            </p>
          ...
          >
            <Link href="/booking">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-foreground rounded-none px-10 py-6 text-lg tracking-widest uppercase">
                Book Villa Now
              </Button>
            </Link>
          </motion.div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <span className="text-primary font-semibold tracking-widest uppercase text-sm">About The Villa</span>
              <h2 className="text-4xl md:text-5xl font-serif text-foreground leading-tight">
                Escape to Your <br/> <span className="text-primary italic">Private Paradise</span>
              </h2>
              ...
              <div className="grid grid-cols-3 gap-6 pt-4">
                <div>
                  <div className="text-3xl font-serif font-bold text-primary">{VILLA.capacity}</div>
                  <div className="text-sm text-muted-foreground">Max Guests</div>
                </div>
                <div>
                  <div className="text-3xl font-serif font-bold text-primary">{VILLA.bedrooms}</div>
                  <div className="text-sm text-muted-foreground">Bedrooms</div>
                </div>
                <div>
                  <div className="text-3xl font-serif font-bold text-primary">{VILLA.bathrooms}</div>
      ...
      <section className="py-24 bg-secondary text-secondary-foreground">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            <span className="text-primary font-semibold tracking-widest uppercase text-sm">What You Get</span>
            <h2 className="text-4xl md:text-5xl font-serif">Premium Features</h2>
            <p className="text-white/60 max-w-2xl mx-auto">
              Thoughtfully designed for comfort with all the amenities you need for a perfect coastal retreat.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {VILLA.amenities.map((amenity, i) => (
              <div key={i} className="flex items-start gap-4 p-6 bg-white/5 hover:bg-white/10 transition-colors">
                <div className="h-8 w-8 bg-primary text-foreground rounded-full flex items-center justify-center shrink-0 font-semibold text-sm">✓</div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            <span className="text-primary font-semibold tracking-widest uppercase text-sm">Perfect Location</span>
            <h2 className="text-4xl md:text-5xl font-serif">Explore the Area</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {VILLA.highlights.map((highlight, i) => (
              <div key={i} className="flex gap-4 p-6 border border-border/50 hover:border-primary/50 transition-colors group">
                ...
                <div>
                  <h4 className="font-serif font-semibold mb-1">{highlight}</h4>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="space-y-6">
              <span className="text-primary font-semibold tracking-widest uppercase text-sm">Services</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className="bg-background p-8 shadow-sm border border-border/50 text-left">
                ...
                <p className="text-muted-foreground mb-6 italic text-sm">"{t.text}"</p>
                <div>
      ...
      <section className="py-32 relative bg-secondary overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center space-y-8">
          <h2 className="text-4xl md:text-6xl font-serif text-white">Ready to Escape?</h2>
          <p className="text-white/70 max-w-xl mx-auto text-lg">
            Book your stay at Bay Woods and experience luxury coastal living in Edaikazhinadu.
          </p>
          <Link href="/booking">
