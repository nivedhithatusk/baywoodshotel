  ...
  return (
    <Layout>
      <div className="bg-secondary py-12 text-center text-white">
        <h1 className="text-4xl font-serif">Reserve Your Villa</h1>
        <p className="text-white/60 mt-2">Secure your dates for an unforgettable stay</p>
      </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="John Doe" className="rounded-none h-12" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} type="email" placeholder="you@example.com" className="rounded-none h-12" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="+91 9876543210" className="rounded-none h-12" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 shadow-lg border-t-4 border-primary sticky top-24">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <div className="text-lg font-serif font-bold text-foreground mb-1">{VILLA.name}</div>
                  <div className="text-xs text-muted-foreground">
                    {VILLA.bedrooms} BR | {VILLA.bathrooms} BA | Up to {VILLA.capacity} guests
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-border mt-4">
                  <div className="flex justify-between items-end mb-2">
                    <div>
                      <span className="text-muted-foreground text-xs">OMR {VILLA.price}/night</span>
                    </div>
                    <span className="text-right font-semibold">OMR {totalPrice}</span>
                  </div>
                  <div className="flex justify-between items-end">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-xs text-muted-foreground">Taxes may apply</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 bg-muted/50 text-xs text-muted-foreground rounded-sm">
                <h4 className="font-bold mb-2 uppercase tracking-wider">Cancellation</h4>
