    ...
    <Layout>
      <div className="relative h-[40vh]">
         ...
         <div className="relative z-10 h-full flex flex-col items-center justify-center text-white">
           ...
           <p className="text-lg font-light">Let's create your perfect beach escape</p>
         </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Have questions about your stay? Want to arrange a special celebration? Our dedicated team is here to help make your beach villa experience truly unforgettable.
            </p>
            ...
            <div className="space-y-6 pt-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-serif text-lg font-semibold mb-1">Location</h4>
          ...
          <div className="bg-muted/30 p-8 border border-border">
            ...
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input className="rounded-none h-12 bg-background" placeholder="How can we help?" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium">Message</label>
                <Textarea className="rounded-none min-h-[150px] bg-background" placeholder="Tell us more..." />
              </div>
